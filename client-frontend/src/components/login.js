...
function Login() {
  ...
  return (
    ...
    <Container>
      ...
      <hr></hr>
      <a href="mailto:njegos.dukic.998@gmail.com?subject=Smart Bilboard - Zaboravljena lozinka&body=Molim Vas da resetujete lozinku za nalog povezan sa ovim mejlom.">Zaboravljena lozinka</a>
